 ...
 *   The form state.
 */
function my_portfolio_zymphonies_subtheme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','my_portfolio_zymphonies_subtheme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'my_portfolio_zymphonies_subtheme'),
